...
public class TextRecognition {
    private final String VOWEL = "aeiouyAEIOUY";
    ...
    private final String yesRegex = "y[.?!]?|yes[.?!]?|yeah[.?!]?|yep[.?!]?|sure[.?!]?|right[.?!]?|affirmative[.?!]?|correct[.?!]?|indeed[.?!]?|you bet[.?!]?|exactly[.?!]?|you said it[.?!]?";
    private final String noRegex = "n[.?!]?|no[.?!]?|no way[.?!]?|nah[.?!]?|nope[.?!]?|negative[.?!]?|i don't think so[.?!]?|yeah no[.?!]?";
